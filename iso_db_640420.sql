...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(58, '2021_04_17_171529_create_request_policies_table', 7),
	(59, '2021_04_17_171552_create_request_policy_details_table', 7);
...
INSERT INTO `request_forms` (`id`, `group_code`, `year`, `order_no`, `created_date`, `request_no`, `change_type`, `request_title`, `request_reason`, `document_relate`, `person_relate`, `system_relate`, `env_impact`, `system_impact`, `level_impact`, `begin_date`, `end_date`, `begin_time`, `end_time`, `status`, `description`, `updated_date`, `created_at`, `updated_at`, `user_id`, `group_id`) VALUES
	(12, 'SECD', 2564, 2, '2021-04-16', 'SECD-2564/002', 1, 'การขอเปลี่ยนแปลงอุปกรณ์เครือข่ายสำหรับระบบ eGP', 'ทดสอบการแก้ไขระบบ', '[]', '["ทรงวุฒิ"]', '[{"value":5,"text":"Network"}]', '[1,2]', '["egp"]', 1, '2021-04-16', '2021-04-17', '08:30:00', '17:00:00', 2, NULL, '2021-04-16', '2021-04-16 18:09:12', '2021-04-16 18:12:23', 1, 1),
	(13, 'SECD', 2564, 0, '2021-04-16', NULL, 0, 'ขอเปิด policy firewall สำหรับกลุ่มงาน security', 'ทดสอบการใช้งานระบบ', '[]', '[]', '[]', '[]', '[]', 1, '2021-04-16', NULL, NULL, NULL, 0, NULL, '2021-04-16', '2021-04-16 18:14:03', '2021-04-16 18:14:03', 1, 1);
/*!40000 ALTER TABLE `request_forms` ENABLE KEYS */;

-- Dumping structure for table cgd_iso.request_policies
CREATE TABLE IF NOT EXISTS `request_policies` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `request_detail_id` smallint(5) unsigned NOT NULL,
  `policy_name` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `updated_date` date NOT NULL,
  `description` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `request_policies_request_detail_id` (`request_detail_id`),
  CONSTRAINT `request_policies_request_detail_id` FOREIGN KEY (`request_detail_id`) REFERENCES `request_details` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table cgd_iso.request_policies: ~0 rows (approximately)
/*!40000 ALTER TABLE `request_policies` DISABLE KEYS */;
/*!40000 ALTER TABLE `request_policies` ENABLE KEYS */;

-- Dumping structure for table cgd_iso.request_policy_details
CREATE TABLE IF NOT EXISTS `request_policy_details` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `request_policy_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `request_policy_details_request_policy_id_foreign` (`request_policy_id`),
  CONSTRAINT `request_policy_details_request_policy_id_foreign` FOREIGN KEY (`request_policy_id`) REFERENCES `request_policies` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user_details` (`id`, `ldap`, `firstname`, `lastname`, `group_id`, `roles`, `last_logon`, `status`, `created_at`, `updated_at`) VALUES
	...
	(4, 'juntharat.ink', 'จันทรัชต์', 'อินทร์แก้ว', 8, '["request","operation","follow"]', NULL, 1, '2021-04-16 07:05:09', '2021-04-16 18:39:33');
