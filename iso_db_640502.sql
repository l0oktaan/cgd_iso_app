...
INSERT INTO `asset_equipment` (`id`, `ip_address`, `equip_name`, `service_port`, `equip_tags`, `group_id`, `description`, `created_at`, `updated_at`) VALUES
	...
	(3, '["10.13.4.43"]', 'vm server', '["any"]', '["เด่นศักดิ์ดา"]', 1, NULL, '2021-04-29 15:29:36', '2021-04-29 15:29:36');
...
INSERT INTO `policies` (`id`, `group_id`, `policy_name`, `updated_date`, `description`, `updated_by`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Policy Firewall สำหรับ Verticar', '2021-04-29', NULL, NULL, '2021-04-29 15:30:42', '2021-04-29 15:30:42');
...
INSERT INTO `policy_details` (`id`, `policy_id`, `source`, `destination`, `service_port`, `updated_date`, `tags`, `created_at`, `updated_at`) VALUES
	(1, 1, '[{"code":"equip_3","asset":"vm server","ldap":"","ip_address":["10.13.4.43"],"tags":["เด่นศักดิ์ดา"]}]', '[{"code":"equip_1","asset":"hdp-data4","ip_address":["10.13.3.8"],"service_port":["9022"],"tags":[]},{"code":"equip_2","asset":"vertica","ip_address":["10.13.2.11"],"service_port":["9022","5433"],"tags":[]}]', '["9022"]', '2021-04-29', '[]', '2021-04-29 15:31:40', '2021-04-29 15:31:40'),
	(2, 1, '[{"code":"equip_3","asset":"vm server","ldap":"","ip_address":["10.13.4.43"],"tags":["เด่นศักดิ์ดา"]}]', '[{"code":"equip_2","asset":"vertica","ip_address":["10.13.2.11"],"service_port":["9022","5433"],"tags":[]}]', '["5433"]', '2021-04-29', '[]', '2021-04-29 15:32:07', '2021-04-29 15:32:07'),
...
INSERT INTO `request_details` (`id`, `type`, `request_detail`, `description`, `created_at`, `updated_at`, `request_form_id`) VALUES
	(1, 2, 'Policy Firewall สำหรับ Verticar', NULL, '2021-04-29 15:35:11', '2021-04-29 15:35:11', 1),
	(2, 2, 'Policy Firewall สำหรับ Verticar', NULL, '2021-04-29 16:21:10', '2021-04-29 16:21:10', 2);
...
INSERT INTO `request_forms` (`id`, `group_code`, `year`, `order_no`, `created_date`, `request_no`, `change_type`, `request_title`, `request_reason`, `document_relate`, `person_relate`, `system_relate`, `env_impact`, `system_impact`, `level_impact`, `begin_date`, `end_date`, `begin_time`, `end_time`, `status`, `description`, `updated_date`, `created_at`, `updated_at`, `user_id`, `group_id`, `camunda_id`, `user_name`) VALUES
	(1, 'SDG1', 2564, 1, '2021-04-29', 'SDG1-2564/001', 1, 'ขอเปิด policy firewall สำหรับการใช้ vertica', 'เพื่อวิเคราะห์ข้อมูลสำหรับโครงการ Bigdata', '[]', '["เด่นศักดิ์ดา ทับทิม"]', '[{"value":5,"text":"Network"}]', '[1,2]', '[]', 1, '2021-03-12', NULL, NULL, NULL, 8, NULL, '2021-04-29', '2021-04-29 15:33:46', '2021-04-29 15:55:39', 12, 1, NULL, 'request1'),
	(2, 'SDG1', 2564, 2, '2021-04-29', 'SDG1-2564/002', 1, 'การขอเปิด Policy สำหรับ Vertica', 'การวิเคราะห์ระบบ Big Data', '[]', '["นาย ก"]', '[{"value":5,"text":"Network"}]', '[1,2]', '[]', 1, '2021-04-29', '2021-05-31', NULL, NULL, 8, NULL, '2021-04-29', '2021-04-29 16:20:51', '2021-04-29 16:33:00', 12, 1, NULL, 'request1');
...
INSERT INTO `request_policy_details` (`id`, `request_detail_id`, `source`, `destination`, `service_port`, `tags`, `created_at`, `updated_at`) VALUES
	(1, 1, '[{"code":"equip_3","asset":"vm server","ldap":"","ip_address":["10.13.4.43"],"tags":["เด่นศักดิ์ดา"]}]', '[{"code":"equip_1","asset":"hdp-data4","ip_address":["10.13.3.8"],"service_port":["9022"],"tags":[]},{"code":"equip_2","asset":"vertica","ip_address":["10.13.2.11"],"service_port":["9022","5433"],"tags":[]}]', '["9022"]', '[]', '2021-04-29 15:35:11', '2021-04-29 15:35:11'),
	(2, 1, '[{"code":"equip_3","asset":"vm server","ldap":"","ip_address":["10.13.4.43"],"tags":["เด่นศักดิ์ดา"]}]', '[{"code":"equip_2","asset":"vertica","ip_address":["10.13.2.11"],"service_port":["9022","5433"],"tags":[]}]', '["5433"]', '[]', '2021-04-29 15:35:11', '2021-04-29 15:35:11'),
	...
	(4, 2, '[{"code":"equip_3","asset":"vm server","ldap":"","ip_address":["10.13.4.43"],"tags":["เด่นศักดิ์ดา"]}]', '[{"code":"equip_1","asset":"hdp-data4","ip_address":["10.13.3.8"],"service_port":["9022"],"tags":[]},{"code":"equip_2","asset":"vertica","ip_address":["10.13.2.11"],"service_port":["9022","5433"],"tags":[]}]', '["9022"]', '[]', '2021-04-29 16:21:10', '2021-04-29 16:21:10'),
	(5, 2, '[{"code":"equip_3","asset":"vm server","ldap":"","ip_address":["10.13.4.43"],"tags":["เด่นศักดิ์ดา"]}]', '[{"code":"equip_2","asset":"vertica","ip_address":["10.13.2.11"],"service_port":["9022","5433"],"tags":[]}]', '["5433"]', '[]', '2021-04-29 16:21:10', '2021-04-29 16:21:10'),
...
INSERT INTO `request_statuses` (`id`, `request_form_id`, `ensure_status`, `ensure_detail`, `ensure_by`, `ensure_date`, `consider_status`, `forward_to`, `consider_detail`, `consider_date`, `consider_by`, `approve_status`, `approve_detail`, `approve_date`, `approve_by`, `operate_status`, `operate_date`, `operator_name`, `operate_detail`, `operate_save_date`, `operate_by`, `follow_status`, `follow_impact`, `follow_detail`, `follow_date`, `follow_by`, `check_status`, `check_detail`, `check_date`, `check_by`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, NULL, 'ensure1', '2021-04-29', 2, '[6]', 'เห็นควนอนุมัติให้ดำเนินการ', '2021-04-29', 'consider', 1, 'ทราบดำเนินการ', '2021-04-29', 'approve', 1, '2021-04-29', 'บ.ดราก้อนมูฟ', 'ดำเนินการแล้ว', '2021-04-29', 'operate', 1, 0, NULL, '2021-04-29', 'request1', 1, NULL, '2021-04-29', 'consider', '2021-04-29 15:35:27', '2021-04-29 15:55:39'),
	(2, 2, 1, 'ทราบดำเนินการ', 'ensure1', '2021-04-29', 2, '[6]', 'เห็นควรอนุมัติดำเนินการ', '2021-04-29', 'consider', 1, 'ทราบดำเนินการ', '2021-04-29', 'approve', 1, '2021-04-29', 'นาย ข', 'ดำเนินการแล้ว', '2021-04-29', 'operate', 1, 0, NULL, '2021-04-29', 'request1', 1, NULL, '2021-04-29', 'consider', '2021-04-29 16:22:01', '2021-04-29 16:33:00');
...
INSERT INTO `user_details` (`id`, `ldap`, `firstname`, `lastname`, `group_id`, `roles`, `last_logon`, `status`, `created_at`, `updated_at`, `user_id`) VALUES
	...
	(67, 'songwut.saj', 'ทรงวุฒิ', 'สัจจบุตร', 7, '["request","consider","follow","check"]', NULL, 1, '2021-04-29 04:30:39', '2021-04-29 04:30:39', 14),
