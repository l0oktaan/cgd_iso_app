...
-- Dumping data for table cgd_iso.documents: ~6 rows (approximately)
...
REPLACE INTO `documents` (`id`, `request_form_id`, `group_code`, `year`, `order_no`, `updated_date`, `created_at`, `updated_at`) VALUES
	...
	(10, 17, 'SDG1', 2564, 1, '2021-04-29', '2021-04-29 04:44:18', '2021-04-29 04:44:18');
...
-- Dumping data for table cgd_iso.oauth_access_tokens: ~53 rows (approximately)
...
-- Dumping data for table cgd_iso.request_details: ~9 rows (approximately)
...
REPLACE INTO `request_details` (`id`, `type`, `request_detail`, `description`, `created_at`, `updated_at`, `request_form_id`) VALUES
	...
	(38, 1, 'เปลี่ยนพัดลม UPS เครื่องที่ 2', NULL, '2021-04-29 03:39:20', '2021-04-29 03:39:20', 17);
...
-- Dumping data for table cgd_iso.request_files: ~1 rows (approximately)
/*!40000 ALTER TABLE `request_files` DISABLE KEYS */;
REPLACE INTO `request_files` (`id`, `request_form_id`, `file_name`, `file_title`, `updated_date`, `created_at`, `updated_at`) VALUES
	(25, 12, '1618596714.pdf', 'Refund.pdf', '2021-04-16', '2021-04-16 18:11:54', '2021-04-16 18:11:54'),
	(26, 17, '1619668265.pdf', 'Doc1.pdf', '2021-04-29', '2021-04-29 03:51:05', '2021-04-29 03:51:05');
...
-- Dumping data for table cgd_iso.request_forms: ~5 rows (approximately)
...
REPLACE INTO `request_forms` (`id`, `group_code`, `year`, `order_no`, `created_date`, `request_no`, `change_type`, `request_title`, `request_reason`, `document_relate`, `person_relate`, `system_relate`, `env_impact`, `system_impact`, `level_impact`, `begin_date`, `end_date`, `begin_time`, `end_time`, `status`, `description`, `updated_date`, `created_at`, `updated_at`, `user_id`, `group_id`, `camunda_id`, `user_name`) VALUES
	(12, 'SECD', 2564, 2, '2021-04-16', 'SECD-2564/002', 1, 'การขอเปลี่ยนแปลงอุปกรณ์เครือข่ายสำหรับระบบ eGP', 'ทดสอบการแก้ไขระบบ', '[]', '["ทรงวุฒิ"]', '[{"value":5,"text":"Network"}]', '[1,2]', '["egp"]', 1, '2021-04-16', '2021-04-17', '08:30:00', '17:00:00', 8, NULL, '2021-04-16', '2021-04-16 18:09:12', '2021-04-24 16:54:24', 1, 1, NULL, 'test'),
	(13, 'SECD', 2564, 2, '2021-04-16', 'SECD-2564/002', 1, 'ขอเปิด policy firewall สำหรับกลุ่มงาน security', 'ทดสอบการใช้งานระบบ', '[]', '[]', '[]', '[1,2,3]', '[]', 1, '2021-04-16', '2021-04-30', NULL, NULL, 8, NULL, '2021-04-24', '2021-04-16 18:14:03', '2021-04-29 08:18:18', 1, 1, NULL, 'test'),
	(14, 'SECD', 2564, 2, '2021-04-23', 'SECD-2564/002', 1, 'การต่ออายุ Policy Firewall สำหรับเจ้าหน้าที่ บ.PCC', 'เพื่อพัฒนา ดูแลระบบ eGP', '[]', '[]', '[]', '[1]', '[]', 1, '2021-04-23', '2021-04-30', NULL, NULL, 8, NULL, '2021-04-24', '2021-04-23 01:36:41', '2021-04-24 17:08:16', 1, 1, NULL, 'test'),
	(15, 'SECD', 2564, 2, '2021-04-24', 'SECD-2564/002', 1, 'การขอให้ VLAN ในห้องประชุม ศทส.', 'เพื่อตรวจรับโครงการ', '[]', '[]', '[]', '[1]', '[]', 1, '2021-04-24', '2021-04-30', NULL, NULL, 7, NULL, '2021-04-27', '2021-04-24 13:18:12', '2021-04-29 08:16:39', 1, 1, NULL, 'test'),
	(17, 'SDG1', 2564, 1, '2021-04-29', 'SDG1-2564/001', 1, 'การเปลี่ยนพัดลม UPS', 'ตรวจพบว่าชำรุด', '[]', '[]', '[{"value":1,"text":"Data Center"}]', '[1]', '[]', 3, '2021-04-01', '2021-04-01', NULL, NULL, 2, NULL, '2021-04-29', '2021-04-29 03:34:57', '2021-04-29 04:44:18', 12, 1, NULL, 'request1');
...
REPLACE INTO `request_policy_details` (`id`, `request_detail_id`, `source`, `destination`, `service_port`, `tags`, `created_at`, `updated_at`) VALUES
...
-- Dumping data for table cgd_iso.request_statuses: ~5 rows (approximately)
...
REPLACE INTO `request_statuses` (`id`, `request_form_id`, `ensure_status`, `ensure_detail`, `ensure_by`, `ensure_date`, `consider_status`, `forward_to`, `consider_detail`, `consider_date`, `consider_by`, `approve_status`, `approve_detail`, `approve_date`, `approve_by`, `operate_status`, `operate_date`, `operator_name`, `operate_detail`, `operate_save_date`, `operate_by`, `follow_status`, `follow_impact`, `follow_detail`, `follow_date`, `follow_by`, `check_status`, `check_detail`, `check_date`, `check_by`, `created_at`, `updated_at`) VALUES
	(1, 13, 1, 'test', 'songwut.saj', '2021-04-24', 2, '[1,3]', 'asdas', '2021-04-24', 'songwut.saj', 1, 'test', '2021-04-24', 'songwut.saj', 1, '2021-04-24', 'asdas', 'sasdasd', '2021-04-24', 'songwut.saj', 1, 1, 'gfgsdfg', '2021-04-24', 'songwut.saj', 1, NULL, '2021-04-29', 'consider', '2021-04-24 10:32:04', '2021-04-29 08:18:18'),
	...
	(4, 15, 1, 'รับรองดำเนินการ', NULL, '2021-04-29', 2, '[6]', 'เห็นควรอนุมัติให้ดำเนินการ', '2021-04-29', 'consider', 1, 'ดำเนินการ', '2021-04-29', 'approve', 1, '2021-04-29', 'บ.ดราก้อน', 'ดำเนินการแล้ว', '2021-04-29', 'operate', 1, 1, NULL, '2021-04-29', 'request1', NULL, NULL, NULL, NULL, '2021-04-27 16:44:31', '2021-04-29 08:16:39'),
	(5, 17, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-04-29 04:44:18', '2021-04-29 04:44:18');
...
-- Dumping data for table cgd_iso.users: ~6 rows (approximately)
...
-- Dumping data for table cgd_iso.user_details: ~52 rows (approximately)
